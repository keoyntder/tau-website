...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        // Evaluate Supabase PostgreSQL configuration at runtime
        $this->default = [
            'DSN'          => '',
            ...
            'strictOn'     => false,
            'failover'     => [],
            'port'         => (int) env('database.default.port', 6543),
            'numberNative' => false,
        ];

        // Set default group to 'tests' when running automated test suites
