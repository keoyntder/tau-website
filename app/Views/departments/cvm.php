...
<title>CVM - Tarlac Agricultural University</title>
...
<section class="dept-hero">
  <div class="dept-hero-inner">
    <img src="<?= base_url('assets/Images/cvm.png') ?>" alt="College of Veterinary Medicine logo" class="dept-hero-logo">
    <div class="dept-hero-text">
      <span class="dept-hero-abbr">CVM</span>
      <h1 class="dept-hero-title">College of Veterinary Medicine</h1>
    </div>
  </div>
</section>
...
<main class="dept-main">
  <section class="dept-section" id="dept-about">
    <h2>About CVM</h2>
    <p>The College of Veterinary Medicine (CVM) trains skilled veterinarians and animal health professionals through rigorous clinical practice, research, and community animal care programs.</p>
  </section>

  <section class="dept-section" id="dept-programs">
    <h2>Programs Offered</h2>
    <p class="dept-placeholder-note">Placeholder — list the degree programs offered by CVM here.</p>
  </section>
