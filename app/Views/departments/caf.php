...
<title>CAF - Tarlac Agricultural University</title>
...
<section class="dept-hero">
  <div class="dept-hero-inner">
    <img src="<?= base_url('assets/Images/caf.png') ?>" alt="College of Agriculture and Forestry logo" class="dept-hero-logo">
    <div class="dept-hero-text">
      <span class="dept-hero-abbr">CAF</span>
      <h1 class="dept-hero-title">College of Agriculture and Forestry</h1>
    </div>
  </div>
</section>
...
<main class="dept-main">
  <section class="dept-section" id="dept-about">
    <h2>About CAF</h2>
    <p>The College of Agriculture and Forestry (CAF) advances sustainable farming, forestry, and natural resource management through research, extension, and field-based instruction.</p>
  </section>

  <section class="dept-section" id="dept-programs">
    <h2>Programs Offered</h2>
    <p class="dept-placeholder-note">Placeholder — list the degree programs offered by CAF here.</p>
  </section>
