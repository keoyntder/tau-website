...
<title>CET - Tarlac Agricultural University</title>
...
<section class="dept-hero">
  <div class="dept-hero-inner">
    <img src="<?= base_url('assets/Images/cetlogo.png') ?>" alt="College of Engineering and Technology logo" class="dept-hero-logo">
    <div class="dept-hero-text">
      <span class="dept-hero-abbr">CET</span>
      <h1 class="dept-hero-title">College of Engineering and Technology</h1>
    </div>
  </div>
</section>
...
<main class="dept-main">
  <section class="dept-section" id="dept-about">
    <h2>About CET</h2>
    <p>The College of Engineering and Technology (CET) prepares students for careers in engineering, information technology, and applied sciences through hands-on training, modern laboratories, and industry-linked programs.</p>
  </section>

  <section class="dept-section" id="dept-programs">
    <h2>Programs Offered</h2>
    <p class="dept-placeholder-note">Placeholder — list the degree programs offered by CET here.</p>
  </section>
