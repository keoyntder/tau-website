...
<title>CBM - Tarlac Agricultural University</title>
...
<section class="dept-hero">
  <div class="dept-hero-inner">
    <img src="<?= base_url('assets/Images/cbm2.png') ?>" alt="College of Business Management logo" class="dept-hero-logo">
    <div class="dept-hero-text">
      <span class="dept-hero-abbr">CBM</span>
      <h1 class="dept-hero-title">College of Business Management</h1>
    </div>
  </div>
</section>
...
<main class="dept-main">
  <section class="dept-section" id="dept-about">
    <h2>About CBM</h2>
    <p>The College of Business Management (CBM) develops future entrepreneurs, managers, and accountants through a curriculum grounded in real-world business practice and ethical leadership.</p>
  </section>

  <section class="dept-section" id="dept-programs">
    <h2>Programs Offered</h2>
    <p class="dept-placeholder-note">Placeholder — list the degree programs offered by CBM here.</p>
  </section>
